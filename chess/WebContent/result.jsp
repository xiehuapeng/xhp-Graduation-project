...
/*    String adname = (String)session.getAttribute("adminname"); 
   ...
   String usernamebefore = (String)session.getAttribute("editname");
   ...
   else
   {
	   ...
	   i2.next();
	   out.println("修改完成！");
	   out.println(" <h2 style='text-align: center'>用户个人信息如下</h2>");
	   %>
	   <div class="content3">
	...
	<tr>
	  ...
	  <!-- <input class="content-form-signup" type="button" onclick="returnmenu()" value="返回主页面"> -->
	  <%
   }
	//   out.println("");
